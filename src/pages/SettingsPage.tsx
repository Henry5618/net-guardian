  ...
  return (
    <div>
      ...
      <div className="mb-6 rounded-md border border-primary/30 bg-primary/5 p-4 text-xs text-primary card-shadow">
        <strong className="block mb-1">Aviso: Modo de Demonstração</strong>
        Esta página de configurações apresenta o design proposto para gerenciamento futuro. As configurações reais do agente de rede são definidas através do arquivo <code>.env</code> e do descobrimento automático do script Python. Alterações visuais feitas aqui não afetarão o monitoramento em tempo real nesta versão do sistema.
      </div>
