...
export default function RulesPage() {
  ...
  return (
    <div>
      ...
      <div className="mb-6 rounded-md border border-primary/30 bg-primary/5 p-4 text-xs text-primary card-shadow">
        <strong className="block mb-1">Aviso: Modo IDS Passivo</strong>
        As regras definidas aqui são uma demonstração da interface visual do sistema. Atualmente, o agente <code>netguard_agent.py</code> opera como um <strong>IDS (Intrusion Detection System)</strong>, escutando a rede de forma 100% passiva. O bloqueio real de conexões exigiria criar um IPS (Intrusion Prevention System) integrado ao Firewall do S.O., o que extrapolaria o escopo desta versão.
      </div>
